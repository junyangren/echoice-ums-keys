...
-- ----------------------------
DROP VIEW IF EXISTS `ec_l2_cakey_view_ori`;
DROP VIEW IF EXISTS `ec_l2_cakey_view`;
--CREATE SQL SECURITY DEFINER VIEW `ec_l2_cakey_view` AS select `tb`.`reportTime` AS `reportTime`,`tb`.`status` AS `status`,count(1) AS `total` from (select `ta`.`op_type` AS `status`,date_format(`ta`.`create_time`,'%Y-%m-%d') AS `reportTime` from `casums_db`.`ec_cakey_order_detail` `ta`) `tb` group by `tb`.`reportTime`,`tb`.`status`;

CREATE VIEW `ec_l2_cakey_view_ori` AS 
  select 
    `ta`.`op_type` AS `status`,
    date_format(`ta`.`create_time`,'%Y-%m-%d') AS `reportTime` 
  from 
    `ec_cakey_order_detail` `ta`

CREATE VIEW `ec_l2_cakey_view` AS 
  select 
    `tb`.`reportTime` AS `reportTime`,
    `tb`.`status` AS `status`,
    count(1) AS `total` 
  from 
    ec_l2_cakey_view_ori `tb` 
  group by 
    `tb`.`reportTime`,`tb`.`status`;
...
INSERT INTO `ec_permission` VALUES ('1','1','1','2009-07-27'), ('2','1','3','2011-04-19'), ('3','1','4','2011-04-19'), ('4','1','5','2011-04-19'), ('5','1','6','2011-04-19'), ('6','1','7','2011-04-19'), ('7','1','8','2011-04-19'), ('8','1','10','2011-04-19'), ('9','1','11','2011-04-19'), ('10','1','9','2011-04-19'), ('110','111','110','2014-07-10'), ('113','111','113','2014-07-10'), ('117','111','117','2015-02-05'), ('124','111','133','2015-05-04'), ('125','111','132','2015-05-04'), ('128','111','136','2015-12-10'), ('130','111','138','2015-12-17'), ('131','111','139','2015-12-17'), ('158','111','167','2017-10-09'), ('159','111','168','2017-10-09'), ('160','111','170','2017-10-10'), ('161','111','171','2017-10-10'), ('162','111','172','2017-10-11'), ('163','111','173','2017-10-12'), ('164','111','174','2017-10-18'), ('170','111','183','2018-10-01'), ('171','111','184','2018-10-01'), ('172','111','185','2018-10-01'), ('173','111','186','2018-10-03'), ('174','1','192','2018-10-04'), ('176','111','192','2018-10-05'), ('177','118','6','2018-10-05'), ('178','118','7','2018-10-05'), ('179','118','189','2018-10-05'), ('180','118','8','2018-10-05'), ('181','118','190','2018-10-05'), ('182','118','9','2018-10-05'), ('183','118','10','2018-10-05'), ('184','118','191','2018-10-05'), ('185','118','183','2018-10-05'), ('186','118','184','2018-10-05'), ('187','118','185','2018-10-05'), ('188','118','186','2018-10-05'), ('189','119','183','2018-10-05'), ('190','119','184','2018-10-05'), ('191','119','185','2018-10-05'), ('192','119','186','2018-10-05');
INSERT INTO `ec_role` VALUES ('1','ums系统管理员角色','ums-admin','y','110','','99999','2015-05-04'), ('110','ums系统角色','ums-role','y','-1','','10','2017-10-09'), ('111','系统管理员角色','app-admin-role','y','114','','1','2018-10-03'), ('114','Key资产管理平台角色','idcard-role','y','-1','','100','2018-10-01'), ('118','普通管理员角色','common-admin-role','y','114','','200','2018-10-05'), ('119','普通用户角色','common-role','y','114','','300','2018-10-05');
INSERT INTO `ec_user` VALUES ('1','超级管理员','root','','C6285F69B6765A5CDD3B09556D84C5BE',NULL,'y',NULL,'99999','2018-09-28',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL), ('110','系统管理员','admin','','9116392DC24B7B84483BA00B0D72B80C','','y',NULL,'99999','2018-09-29','18950295821','','','',NULL,'',NULL,NULL), ('120','test','test','test','49BF6CD1A87F97AC1D6C4BC45ABA857D','test1@qq.com','y',NULL,'9999','2018-09-29','','','','',NULL,'',NULL,NULL), ('146','小张','350583197210211001',NULL,'8AC00157D7B4A4471116682C49D75D9A',NULL,'y',NULL,'9999','2018-10-01','18950295811',NULL,NULL,NULL,NULL,NULL,NULL,'350583197210211001'), ('147','小李','350583197210211002',NULL,'C7FEF7F63ACF35645F20FF76FD43A0F3',NULL,'y',NULL,'9999','2018-10-01','18950295812',NULL,NULL,NULL,NULL,NULL,NULL,'350583197210211002'), ('148','天一','350583197210211003',NULL,'E3E3590E3472B27ACE184B1C0B892B67',NULL,'y',NULL,'9999','2018-10-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'350583197210211003'), ('149','天二','350583197210211004',NULL,'DECE8BB5FA54C6A3928806591AB89E7F',NULL,'y',NULL,'9999','2018-10-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'350583197210211004'), ('150','天三','350583197210211005',NULL,'7F656B57F03DD1E8C32CA9D295801CF6',NULL,'y',NULL,'9999','2018-10-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'350583197210211005'), ('151','管理员1','admin1','','A4F272FA5EE6BF3335DF6D6436752A0C','','y',NULL,'9999','2018-10-05','','','','',NULL,'',NULL,NULL);
INSERT INTO `ec_users_assignmen` VALUES ('1','1','1',NULL), ('110','110','1','2014-07-10'), ('111','110','111','2014-07-10'), ('122','151','118','2018-10-05');
INSERT INTO `ec_user_cakey` VALUES ('33','350583197210211001','a00001','04','2018-10-01 23:59:13','admin','2018-10-02 00:04:50','admin'), ('34','350583197210211002','a00002','03','2018-10-01 23:59:13','admin','2018-10-05 13:44:09','admin1'), ('35','350583197210211003','a00003','03','2018-10-01 23:59:13','admin','2018-10-02 00:02:27','admin'), ('36','350583197210211004','a00004','02','2018-10-01 23:59:13','admin','2018-10-02 00:00:28','admin'), ('37','350583197210211005','a00005','02','2018-10-01 23:59:13','admin','2018-10-01 23:59:22','admin'), ('38','350583197210211001','b00001','02','2018-10-03 14:18:42','admin','2018-10-05 22:51:05','admin1'), ('39','350583197210211002','b00002','03','2018-10-03 14:18:42','admin','2018-10-05 13:44:09','admin1'), ('40','350583197210211003','b00003','02','2018-10-03 14:18:42','admin','2018-10-04 10:56:26','admin'), ('41','350583197210211004','b00004','02','2018-10-03 14:18:42','admin','2018-10-04 10:56:26','admin'), ('42','350583197210211005','b00005','02','2018-10-03 14:18:42','admin','2018-10-04 10:56:26','admin'), ('43','350583197210211005','c00005','02','2018-10-03 14:19:18','admin','2018-10-03 14:21:08','admin'), ('48','350583197210211001','c00001','02','2018-10-04 12:07:15','admin','2018-10-05 22:51:05','admin1'), ('49','350583197210211002','c00002','03','2018-10-04 12:07:15','admin','2018-10-05 13:44:09','admin1'), ('50','350583197210211003','c00003','01','2018-10-04 12:07:15','admin','2018-10-04 12:07:15','admin'), ('51','350583197210211004','c00004','04','2018-10-04 12:07:15','admin','2018-10-05 13:47:02','admin1'), ('52','350583197210211005','d000001','01','2018-10-05 15:21:36','admin','2018-10-05 15:21:36','admin');
INSERT INTO `ec_user_extend` VALUES ('1','','','','',NULL,'11',NULL), ('110','','','','',NULL,'',NULL), ('111','','',NULL,'','','',NULL), ('112','','',NULL,'','','',NULL), ('117','','',NULL,'','','',NULL), ('119','','',NULL,'','','',NULL), ('120','','','','',NULL,'',NULL), ('121','','','','',NULL,'',NULL), ('122','','','','',NULL,'',NULL), ('123','-7','','','',NULL,'',NULL), ('124','','','','',NULL,'',NULL), ('151','','','','',NULL,'',NULL);
INSERT INTO `ec_user_group` VALUES ('1','1','1'), ('110','110','110'), ('116','110','120'), ('142','121','146'), ('143','122','147'), ('144','122','148'), ('145','122','149'), ('146','122','150'), ('147','120','151');
